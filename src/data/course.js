    ...
    modules: [
      {
        ...
        activity: "Summarise a 10-page report into a 1-page brief, audit it, and peer-review a partner's.",
        deliverable: "executive-brief.md with peer-review stamp",
        challenge: null,
        example:
          "A government publishes a 20-page annual report on digital ID adoption. Compress it into a 1-page exec brief covering TL;DR (3 lines), Key Findings (5), Risks (3), and Recommendations (3) — then audit every claim against page numbers and rewrite any sentence you cannot source.",
        steps: [
          "Instructor demo (10 min): live-summarise a 10-page report using Gemini in front of the room. Show how to anchor the brief to the source.",
